...
import com.smktelkommlg.kasirapp.databinding.RvCardMakananBinding
...
class AdapterFood(private val context: Context, private val foods : ArrayList<Food>, private val foodViewModel: MenuViewModel): RecyclerView.Adapter<AdapterFood.ViewHolder>()  {
    inner class ViewHolder(private val binding : RvCardMakananBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(food: Food){
            ...
            when(food.image){
                1 -> binding.cardMakananIvImage.setImageResource(R.drawable.pizza)

                2 -> binding.cardMakananIvImage.setImageResource(R.drawable.samyang)

                3 -> binding.cardMakananIvImage.setImageResource(R.drawable.seblak)
